...
from graphs.general_assistant2 import Agent, memory, Response
...
def chatbot_anwser(user_messages: List[Dict[str, Any]], config: Dict[str, Any]):
    ...
    print("\nCHATBOT ANSWER:")
    print(response)
    return response["messages"][-1].tool_calls[0]["args"]["output"]["response"]
...
def show():
    ...
    if prompt := st.chat_input("Hi! Ask me anything...") or audio_prompt:
        ...
        with st.chat_message("assistant"):
            ...
            # T.B.D. differentiate between: text, iamge and hyperlinks
